...
export const VerifyOtpResponse = zod.object({
  ...
  "onboardingStep": zod.enum(['consent', 'profile', 'track_selection', 'pre_assessment', 'pending_approval', 'complete']),
  "approvalStatus": zod.union([zod.literal('approved'),zod.literal('pending'),zod.literal('rejected'),zod.literal(null)]).nullish().describe('Approval gate for tpo\/employer accounts; null for roles without an approval flow.'),
